for s = 1:8
    ...
    for t = [1 2 3 4 7 13 19 25 49 97 145]
        ...
        path = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN029_live_nucleus_mask/live_nucleus_mask/s%d', s);
        addpath(path);
    ...
    save('/Users/yijiachen/Documents/B_Cell_project/panel_cd/data_saved/HVN029_CFP_nucleus_live_mask_value.mat','CFP_nucleus_live_mask_all_t')
    save('/Users/yijiachen/Documents/B_Cell_project/panel_cd/data_saved/HVN029_YFP_nucleus_live_mask_value.mat','YFP_nucleus_live_mask_all_t')

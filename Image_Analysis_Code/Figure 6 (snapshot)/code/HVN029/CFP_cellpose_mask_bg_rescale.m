...
%         imshow(CFP_img_bg_mask);
        ...
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN029_cellpose_bg_mask/s%d/CFP_cellpose_bg_mask_%d.tiff', s, t);
    ...
    %     save('/Users/yijiachen/Documents/B_Cell_project/panel_cd/data_saved/HVN029_CFP_wholecell_value.mat','CFP_wholecell_all_t')
end

bg_mean_HVN029 = mean(CFP_img_bg_mask_nonzero_mean,'all');
bg_median_HVN029 = median(CFP_img_bg_mask_nonzero_median,'all');
save('/Users/yijiachen/Documents/B_Cell_project/panel_cd/data_saved/HVN029_CFP_bg_mean_median.mat','bg_mean_HVN029','bg_median_HVN029')

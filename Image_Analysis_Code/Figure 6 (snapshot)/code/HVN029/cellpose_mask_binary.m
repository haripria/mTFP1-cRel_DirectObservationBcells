for s = 1:8
    ...
    for t = [1 2 3 4 7 13 19 25 49 97 145]
        path = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN029_live_nucleus_mask/APC_death_mask/s%d',s);
        addpath(path);
        ...
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN029_live_nucleus_mask/CFP_wholecell_masked/s%d/CFP_wholecell_masked_%d.tiff', s, t);

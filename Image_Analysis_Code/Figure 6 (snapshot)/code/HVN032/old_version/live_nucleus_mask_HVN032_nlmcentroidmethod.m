for s = 1:9
    ...
    for t = [1 2 3 4 7 13 19 25 49 97 145]
        ...
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN032_live_nucleus_mask/APC_death_mask/s%d/APC_death_mask_%d.tiff',s, t);
        ...
        %         hold on
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN032_live_nucleus_mask/mCherry_nucleus_mask/s%d/mCherry_nucleus_mask_%d.tiff',s, t);
        imwrite(mCherry_nuclear_mask, savePath);


        %% Live Mask
        label_mCherry = bwlabel(mCherry_nuclear_mask);
        %             s_mCherry = regionprops(label_mCherry, 'Centroid');
        ...
        %
        % % Save the combined binary mask as an image (optional)
        % imwrite(final_live_mask, 'combined_binary_mask.png');
        %
        %
        %
        ...
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN032_live_nucleus_mask/live_nucleus_mask/s%d/live_nucleus_mask_%d.tiff',s, t);

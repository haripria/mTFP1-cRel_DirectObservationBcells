...
for c_num = 1: (tot_cell_num-1)
    ...
    [YFP_pks,locs] = findpeaks(YFP_sgf_int(YFP_sgf_time<601));
...
save('/Users/yijiachen/Documents/B_Cell_project/HVN029/data_saved/HVN029_YFP_nuc_peak_amp_time.mat','YFP_peak_amp','YFP_peak_time','YFP_basal_amp')
...
% saveas(YFP_nuclear_medianint_plot_smoothed,'/Users/yijiachen/Documents/B_Cell_project/HVN029/images/YFP_nuc_rep_traj/fluor_plot_medianint_smoothed_newscale.png')

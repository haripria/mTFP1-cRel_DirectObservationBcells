...
CFP_YFP_variables = CFP_YFP_variables(CFP_YFP_variables(:, 5) < 400, :);
% Variable Names
...
for i = 1:numVars
    for j = 1:i-1 % Only consider lower half to avoid redundant pairs
        ...
        saveas(scatter_plot, sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN032/images/correlation_scatter_filtered/%s_%s.png', CFP_YFP_variable_names{j}, CFP_YFP_variable_names{i}));
        %         end
    end
end

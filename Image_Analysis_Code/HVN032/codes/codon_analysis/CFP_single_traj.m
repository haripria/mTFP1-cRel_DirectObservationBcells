...
for cell = tot_cell(k)
    ...
    [minValue, minIndex] = min(valid_time_CFP);
    CFP_basal_time(tot_cell_num,1)  = valid_time_CFP(minIndex);
    CFP_basal_amp(tot_cell_num,1)  =CFP_sgf(minIndex, 2);
...
save('/Users/yijiachen/Documents/B_Cell_project/HVN029/data_saved/HVN029_CFP_nuc_peak_amp_time.mat','CFP_peak_amp','CFP_peak_time','CFP_basal_amp','CFP_fold_change')
...
%saveas(CFP_nuclear_medianint_plot_smoothed,'/Users/yijiachen/Documents/B_Cell_project/HVN029/images/CFP_nuc_rep_traj/fluor_plot_medianint_smoothed.png')
saveas(CFP_nuclear_medianint_plot_smoothed,sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/images/CFP_nuc_rep_traj/fluor_plot_medianint_smoothed_c%d.png',cell))

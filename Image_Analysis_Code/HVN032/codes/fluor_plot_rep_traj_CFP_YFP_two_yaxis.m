...
%     ylabel('CFP/YFP nuclear median intensity')
    ...
    saveas(CFP_YFP_nuclear_medianint_plot,sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN032/images/CFP_YFP_nuc_rep_traj_two_yaxis/fluor_plot_medianint_c%d.png',tot_cell(tot_cell_num)))

...
xticklabels({'0',  '8',  '16', '24',  '32',  '40', '48'});
  title('CFP nuclear mean intensity', 'FontSize', 18)
xlabel('time (h)', 'FontSize', 16)
ylabel('CFP nuclear sum intensity', 'FontSize', 16)

 
%     legend ('CFP','YFP')
  saveas(CFP_nuclear_plot,'/Users/yijiachen/Documents/B_Cell_project/HVN032/images/s1/CFP_all_cell.png')

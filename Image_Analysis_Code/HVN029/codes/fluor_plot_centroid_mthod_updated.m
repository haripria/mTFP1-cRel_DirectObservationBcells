...
for s = [2,3,4,5,6,7,8]
    ...
    trackmate_filmname = sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/trackmate_data/HVN029_BF_All_s%d_ORG_concat_trackdata.mat', s);
    load(trackmate_filmname)
    %     load('/Users/yijiachen/Documents/B_Cell_project/HVN029/trackmate_data/HVN029_BF_ALL_s1_t0001_t3000_ORG_Concat_trial1_trackdata.mat'); % Load the centroid data
    ...
    for cell_num = 1:size(alltrackData,2)
        ...
        for r =   1:size(frame_tot,1)
            ...
            if mod(frame_num - 1, 20) == 0
                t = (frame_num - 1) / 20 + 1;
                path_CFP = sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/images/HVN029_live_nucleus_mask/CFP_masked/s%d', s);
                addpath(path_CFP);
                %             addpath '/Users/yijiachen/Documents/B_Cell_project/HVN029/images/HVN029_live_nucleus_mask/CFP_masked/s1'
                ...
                %             addpath '/Users/yijiachen/Documents/B_Cell_project/HVN029/images/HVN029_live_nucleus_mask/YFP_masked/s1'
                path_YFP = sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/images/HVN029_live_nucleus_mask/YFP_masked/s%d', s);
                addpath(path_YFP);
...
% % % % % %                                 hold off;
% % % % % %                                 title('YFP Image');
% % % % % %                 % %                 saveas(centroid_benchmark,sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/images/benchmark/s1/c%d/centroid_benchmark_c%d_t%d.png',cell_num,cell_num,t))
% % % % % %                 % %             close all
% % % % % % 
% % % 
...
% % %                 % % % %                 hold off;
% % %                                 title(sprintf('CFP Image with Centroids at Frame %d', t));
...
% % %                 % % %                 legend('Tracked Centroid', 'YFP Centroids');
        ...
        legend ('CFP','YFP')
        saveas(YFP_CFP_nuclear_meanint_plot,sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/images/fluor_nuc_traj/s%d/fluor_plot_meanint_c%d.png',s,cell_num))
        ...
        legend ('CFP','YFP')
        saveas(YFP_CFP_nuclear_medianint_plot,sprintf('/Users/yijiachen/Documents/B_Cell_project/HVN029/images/fluor_nuc_traj/s%d/fluor_plot_medianint_c%d.png',s,cell_num))
...
save('/Users/yijiachen/Documents/B_Cell_project/HVN029/data_saved/HVN029_CFP_YFP_nuc_median_mean_int.mat','CFP_MedianIntensity_nuc_tot','YFP_MedianIntensity_nuc_tot','CFP_MeanIntensity_nuc_tot','YFP_MeanIntensity_nuc_tot')

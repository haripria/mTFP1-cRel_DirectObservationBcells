...
% %         path = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN037_live_nucleus_mask/APC_death_mask/s%d',s);
% %         addpath(path);
...
% %         end
        ...
        path = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN037_BF_mask/s%d', s);
        addpath(path);
        filename_cellpose_mask = ['HVN037_Fluo_ALL_t', num2str(t,'%03.f'), '_cp_masks', '.png'];
        ...
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN037_live_nucleus_mask/cellpose_wholecell_masked/s%d/cellpose_wholecell_mask_%d.tiff',s, t);
        ...
        savePath = sprintf('/Users/yijiachen/Documents/B_Cell_project/panel_cd/HVN037_live_nucleus_mask/CFP_wholecell_masked/s%d/CFP_wholecell_masked_%d.tiff', s, t);
        ...
        save('/Users/yijiachen/Documents/B_Cell_project/panel_cd/data_saved/HVN037_CFP_wholecell_value.mat','CFP_wholecell_all_t')
end
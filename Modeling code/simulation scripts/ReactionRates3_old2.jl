# Using proliferation module in the new version (Hari's version) and NFkB module in the old version (Mitchell 2018)
...
function setAllRates!(rates)
    ...
    #-----------------------------------------------------------------------
    # 01 : tIkBa # CHANGED basalsynthesis and basaldecay
    setParams!((@view rates[TIKBA, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.288, synthesis=0, translation=0, basaldecay=1.728, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 04 : tIkBb # CHANGED basalsynthesis
    setParams!((@view rates[TIKBB, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.072, synthesis=0, translation=0, basaldecay=0.1728, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 07 : tIkBe
    setParams!((@view rates[TIKBE, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=IKBE_MOD*0.00432, synthesis=0, translation=0, basaldecay=0.2304, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 10 : tIkBd
    ...
    # 05 : IkBb
    setParams!((@view rates[IKBB, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0, synthesis=0, translation=720, basaldecay=7.2, decay=0.081, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0.54, transport_out=0);
    # 08 : IkBe # CHANGED decay to 0.054, then to 0.081?
    setParams!((@view rates[IKBE, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0, synthesis=0, translation=720, basaldecay=0.693, decay=0.081, association=0, dissociation=0, activation=0, deactivation=0, transport_in=2.7, transport_out=0);
    # 11 : IkBd # CHANGED decay
    ...
    # 16 : tP50 # CHANGED basalsynthesis to multiply constituitiveMultiplier
    setParams!((@view rates[TP50, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.00432*constituitiveMultiplier, synthesis=0, translation=0, basaldecay=0.1728, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    # 19 : tcRel # CHANGED basalsynthesis to multiply constituitiveMultiplier
    setParams!((@view rates[TCREL, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.00432*constituitiveMultiplier, synthesis=0, translation=0, basaldecay=0.1728, decay=0, association=0, dissociation=0, activation=0, deactivation=0, transport_in=0, transport_out=0);
    #---------------------
    # 14 : RelA
    ...
    setParams!((@view rates[GEN24, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.0, synthesis=0.0, translation=0.0, basaldecay=0.0, decay=0.0, association=0.0, dissociation=0.0, phosphorylation=0.0, dephosphorylation=0.0);
    setParams!((@view rates[GEN36, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.0, synthesis=0.0, translation=0.0, basaldecay=0.0, decay=0.0, association=0.0, dissociation=0.0, phosphorylation=0.0, dephosphorylation=0.0);
    setParams!((@view rates[GEN48, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.0, synthesis=0.0, translation=0.0, basaldecay=0.0, decay=0.0, association=0.0, dissociation=0.0, phosphorylation=0.0, dephosphorylation=0.0);
    setParams!((@view rates[GEN60, 1:end]), initialConc=0, scale=CONVERSION, basalsynthesis=0.0, synthesis=0.0, translation=0.0, basaldecay=0.0, decay=0.0, association=0.0, dissociation=0.0, phosphorylation=0.0, dephosphorylation=0.0);
    # !!!!!!!!! SUBJECT TO CHANGE !!!!!!!!!!

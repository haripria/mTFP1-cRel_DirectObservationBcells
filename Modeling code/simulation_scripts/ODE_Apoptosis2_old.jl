...
function computeApoptosisNettFluxes!(nettFlux, concentration, reactionFlux, Srates, phase, time, birthday, inputCurves)
    ...
    # Compute Apoptosis reaction fluxes
    # computeApoptosisFluxes!(concentration, reactionFlux, Srates, phase); #CHANGED to not simulate apoptosis module to save time
    # Compute Apoptosis net fluxes
    # ApoptosisNettFluxes!(nettFlux, reactionFlux); #CHANGED to not simulate apoptosis module to save time
    nothing
end
